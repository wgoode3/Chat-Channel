...
<tt>gem 'therubyracer', platform: :ruby</tt>
...
You will need to edit /app/views/channels/show.html.erb (currently at line 157) and /app/views/channels/main.html.erb (line 60) to reflect the IP of the server
...
To properly test the live streaming video be sure to set up the an NGINX server for RTMP streams.
